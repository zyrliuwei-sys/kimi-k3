...
/**
 * Bento grid of 4 product features. Layout (md+): [3][2] / [2][3].
 * The 3-wide card carries a flow animation (SkeletonOne), the 2-wide middle
 * card carries the rotating cobe globe (SkeletonTwo / <Globe />), and the
 * 2-wide end cards carry decorative imagery. Card content is sourced from
 * `landing.features.card_{1..4}.*` so a single edit updates both locales.
 */
  ...
  return (
    <section id="features" className="px-4 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl">
        <BentoHeader>
          <h2 className="mx-auto w-fit text-center font-sans text-xl font-bold tracking-tight md:text-4xl">
        ...
        <div className="cols-1 mt-20 grid gap-4 md:auto-rows-[25rem] md:grid-cols-5">
          <Card className="flex flex-col justify-between md:col-span-3">
            ...
            <CardContent className="h-40">
              <CardTitle>{m['landing.features.card_1.title']()}</CardTitle>
              <CardDescription>
                {m['landing.features.card_1.description']()}
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="flex flex-col justify-between md:col-span-2">
            <CardContent className="h-40">
              <CardTitle>{m['landing.features.card_2.title']()}</CardTitle>
              <CardDescription>
                {m['landing.features.card_2.description']()}
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
          ...
          <Card className="flex flex-col justify-between md:col-span-2">
            <CardContent className="h-40">
              <CardTitle>{m['landing.features.card_3.title']()}</CardTitle>
              <CardDescription>
                {m['landing.features.card_3.description']()}
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
              <SkeletonTwo />
          ...
          <Card className="flex flex-col justify-between md:col-span-3">
            <CardContent className="h-40">
              <CardTitle>{m['landing.features.card_4.title']()}</CardTitle>
              <CardDescription>
                {m['landing.features.card_4.description']()}
              </CardDescription>
            </CardContent>
            <CardSkeletonBody>
              <div className="mt-2 ml-6 h-full w-full rounded-lg border border-neutral-200 bg-neutral-100 p-4 dark:border-neutral-700 dark:bg-neutral-800">
                <img
                  ...
                  alt="Kimi K3 playground with copy-ready code examples"
                  width={500}
                  height={500}
                  className="w-full rounded-lg object-cover"
                />
...
// Header — accent-border frame that scales in on mount
const BentoHeader = ({ children }: { children: React.ReactNode }) => {
  return (
...
// Skeleton #1 — three animated tiles with flow connectors (decorative flow
// diagram: a code snippet → repo mark → deploy mark → "live" badge).
...
// Skeleton #2 — wraps the rotating cobe globe
...
// Globe — cobe canvas, animated markers on city coordinates. Caller controls
// positioning via `className` (the canvas itself is 600x600 with max-width 100%).
